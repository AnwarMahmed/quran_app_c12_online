...
import 'package:test1/prsentation/screens/home/tabs/quran_tabs/widgets/sura_name_widget.dart';
...
class QuranTabs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      Expanded(flex: 1, child: Image.asset(AssetsManager.headerImage)),
      QuranHeaderWidget(),
      Expanded(
        flex: 2,
